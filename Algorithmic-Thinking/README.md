# Algorithmic Thinking + Reflection
...
Shows the n8n Form Trigger receiving user details.

### JavaScript Domain Check

Displays the custom JavaScript code used to classify email domains.

### Decision Node

Shows the IF node directing execution based on whether the email is personal or business.

### People Data Labs API

Displays the API call used for professional contact enrichment.

### Personalized Email

Shows the Gmail node sending a customized proposal email.

### Generic Welcome Email

Displays the Gmail node responsible for sending the welcome email.

### Final Email Output

Shows the email successfully delivered to the recipient.
